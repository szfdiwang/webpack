<template>
  <div class="willer-Bg">
    <div class="title_box">
      <span class="titleFont">新增用户</span>
    </div>
    <div class="check-box">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="1rem">
          <div class="tab_line_inner_box">
            <el-form-item label="登录名:" prop="loginId">
              <el-input size="mini" v-model="ruleForm.loginId" placeholder="请输入登录名"></el-input>
            </el-form-item>
          </div>
          <div class="tab_line_inner_box">
            <el-form-item label="姓名:" prop="userNames">
              <el-input size="mini" v-model="ruleForm.userNames" placeholder="请输入姓名"></el-input>
            </el-form-item>
          </div>
          <div class="tab_line_inner_box">
            <el-form-item label="密码:" prop="pass">
              <el-input size="mini" type="password" v-model="ruleForm.pass" placeholder="请输入密码"></el-input>
            </el-form-item>
          </div>
          <div class="tab_line_inner_box">
            <el-form-item label="密码确认:" prop="confPassword">
              <el-input size="mini" type="password" v-model="ruleForm.confPassword" placeholder="请确认密码"></el-input>
            </el-form-item>
          </div>
          <div class="tab_line_inner_box">
          ...
          <el-form-item style="margin-top:.2rem;">
            <el-button @click="add('ruleForm')" size="mini" type="primary">确定</el-button>
      ...
      add(formName) {
        this.$refs[formName].validate(valid => {
          if (valid) {
            ...
            param.userName = this.ruleForm.userNames;
